...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[var(--border-main)] bg-[var(--surface)] px-6 py-14 text-center">
      ...
      <p className="mt-1 max-w-sm text-[15px] leading-relaxed text-[var(--text-secondary)]">
        {description}
      </p>
